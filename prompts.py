...
first_stage_prompt = """
    Task Instruction: Given a word or a phrase, use the provided context to infer if the given word or phrase is offensive or non-offensive. When analyzing the usage contexts, interpret the context literally and think through it carefully to infer if the word (or the phrase) is offensive or non-offensive. If whether it is offensive or not cannot be inferred from the context, it is appropriate to say, "Unclear."
    Word: {mispelled_word}
    Context: {context}
    Output format: Offensive, Non-offensive, or Unclear Only
"""

second_stage_prompt = """
    Task Instruction: Given a context with a masked word (or phrase), analyze the context and if the given word or phrase is offensive or non-offensive. Think through the context carefully to deduce if the given word or phrase is offensive or non-offensive. If whether it is offensive or not cannot be inferred from the context, it is appropriate to say, "Unclear."
    Context with Masked Phrase: {context_with_masked_mispelled_word}
    Output format: Offensive, Non-offensive, or Unclear Only
"""

third_stage_prompt = """
    Task Instruction: Given a paraphrased context with a masked word (or phrase), analyze the context and if the given word or phrase is offensive or non-offensive. Think through the context carefully to deduce if the given word or phrase is offensive or non-offensive. If whether it is offensive or not cannot be inferred from the context, it is appropriate to say, "Unclear."
